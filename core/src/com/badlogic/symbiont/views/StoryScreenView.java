...
public class StoryScreenView extends Actor {
    ...
    private Animator backgroundAnimation = new Animator(Assets.loadAnimation("intro_story/intro_story"));
...
//            storyImages[i] = new TextureRegionDrawable(Assets.loadAtlas("intro_story_"+i));
//        }
//        curPage = 0;
//    }
//
