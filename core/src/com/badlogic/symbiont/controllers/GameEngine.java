...
public class GameEngine implements Screen {
    ...
    public Body setUpDeflector() {
        ...
        deflectorDef.position.set(
                gameState.deflectorEndpoints[0].x / GameConstants.PIXELS_PER_METER,
                gameState.deflectorEndpoints[0].y / GameConstants.PIXELS_PER_METER
        );

        deflectorPoints[0].set(0,0);
        deflectorPoints[1].set(
                (gameState.deflectorEndpoints[1].x - gameState.deflectorEndpoints[0].x) / GameConstants.PIXELS_PER_METER,
                (gameState.deflectorEndpoints[1].y - gameState.deflectorEndpoints[0].y) / GameConstants.PIXELS_PER_METER
        );
